...
define('UL_PDO_CON_STRING', 'mysql:host='.$mconfig["db_host"].';dbname='.$mconfig["db_name"]);
// Example for SQLite: 
...
// logins table.
define('UL_PDO_AUTH_USER', $mconfig["db_user"]);
define('UL_PDO_AUTH_PWD', $mconfig["db_pass"]);

// LOGIN UPDATE
// Used to add new and modify login data.
// Database user with SELECT, UPDATE and INSERT access to the
// logins table.
define('UL_PDO_UPDATE_USER', $mconfig["db_user"]);
define('UL_PDO_UPDATE_PWD', $mconfig["db_pass"]);

// LOGIN DELETE
// Used to remove logins.
// Database user with SELECT and DELETE access to the
// logins table
define('UL_PDO_DELETE_USER', $mconfig["db_user"]);
define('UL_PDO_DELETE_PWD', $mconfig["db_pass"]);

// SESSION
// Database user with SELECT, UPDATE and DELETE permissions to the
// sessions and nonces tables.
define('UL_PDO_SESSIONS_USER', $mconfig["db_user"]);
define('UL_PDO_SESSIONS_PWD', $mconfig["db_pass"]);

// LOG
// Used to log events and analyze previous activity.
// Database user with SELECT, INSERT and DELETE access to the
// logins-log table.
define('UL_PDO_LOG_USER', $mconfig["db_user"]);
define('UL_PDO_LOG_PWD', $mconfig["db_pass"]);
