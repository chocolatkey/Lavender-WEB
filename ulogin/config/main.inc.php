...
define('UL_INC_DIR', dirname(dirname(__FILE__)));//the ulogin dir
...
define('UL_SITE_KEY', $mconfig["ul_key"]);
...
define('UL_SITE_ROOT_DIR', dirname(dirname(dirname(__FILE__))));//temporary fix
